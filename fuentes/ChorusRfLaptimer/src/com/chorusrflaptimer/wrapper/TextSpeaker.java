...
//            }
    ...
    public void speakMillisecondsInFriendlyTime(int ms) {
        ...
        String text = "";
        String seconds = s + decimalSeparator + mills + UtilMessage.getMsg("seconds_short");
        ...
        if (m > 0) {
        	...
        	String minutes = UtilMessage.getMsg("minutes.other");
            text = minutes + " ";
        }
    ...
    public void speak(String stringRes, Object... args) {
